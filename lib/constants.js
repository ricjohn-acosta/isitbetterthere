export const API_SERVER = process.env.NODE_ENV === "production" ? process.env.HEROKU_ENV === 'prod' ? "https://www.isitbetterthere.com" : "https://isitbetterthere-dev.herokuapp.com" : process.env.local
